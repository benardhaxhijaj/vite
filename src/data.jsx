export default [
  ...
  {
    id: 2,
    title: "Everyday Running Lessons",
    description:
      "Interested in becoming a marathon runner? For beginner and experienced runers alike, join us in learning techniques required to lead to a happy life with memories that'll last a lifetime.",
    price: 125,
    coverImg: "runing.jpg",
    stats: {
      rating: 5.0,
